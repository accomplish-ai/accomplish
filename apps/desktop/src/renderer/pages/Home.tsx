...
const USE_CASE_EXAMPLES = [
  ...
  },
  {
    ...
    prompt:
      'Go to my Gmail inbox and delete all promotional emails from the last 24 hours.',
    image: inboxPromoCleanupImg,
  },
  {
    title: 'Competitor Pricing Deck',
    description:
      'Analyze competitor pricing and draft a slide with recommendations.',
    prompt:
  ...
  },
  {
    ...
    prompt:
      'Monitor my stock portfolio on [broker site], alert on price drops and spikes.',
...
export default function HomePage() {
  ...
  const [settingsInitialTab, setSettingsInitialTab] = useState<
    'providers' | 'voice'
  >('providers');
  const { startTask, isLoading, addTaskUpdate, setPermissionRequest } =
    useTaskStore();
