...
function LMStudioModelSelector({
  ...
  const sortedModels = [...models].sort((a, b) => {
    const order: Record<ToolSupportStatus, number> = {
      supported: 0,
      unknown: 1,
      unsupported: 2,
    };
...
export function LMStudioProviderForm({
  ...
  const models: LMStudioModel[] = (
    ...
    return {
      ...
      name: m.name,
      toolSupport:
        (m as { toolSupport?: ToolSupportStatus }).toolSupport || 'unknown',
    };
  });
            ...
            >
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Start LM Studio and enable the local server in Developer
                  settings
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  type="text"
                  value={
                    (connectedProvider?.credentials as LMStudioCredentials)
