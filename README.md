...
Openwork is an open source AI desktop agent that automates file management, document creation, and browser tasks locally on your machine. Bring your own API keys (OpenAI, Anthropic, Google, Minimax, xAI) or run local models via Ollama.
...
- Use your own API key (OpenAI, Anthropic, Minimax, xAI, etc.)
...
| Step | Action | Details |
|:----:|--------|---------|
| **1** | **Install App** | Download DMG and drag it into Applications |
| **2** | **Connect Your AI** | Use your own OpenAI, Anthropic, Minimax, or xAI API key, or Ollama. No subscriptions. |
...
You can use your own API keys (OpenAI, Anthropic, Google, Minimax, xAI) or run local models via Ollama.
